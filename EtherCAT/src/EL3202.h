...
class EL3202 : public AbstractTerminal
{
	public:
		...
		Input<bool> getUnderrangeStatus( unsigned int channel );
		Input<bool> getOverrangeStatus( unsigned int channel );
		Input<bool> getErrorStatus( unsigned int channel );
		Input<bool> getTxPdoStateStatus( unsigned int channel );
		Input<bool> getTxPdoToggleStatus( unsigned int channel );
		Input<uint8_t> getLimit1Status( unsigned int channel );
		Input<uint8_t> getLimit2Status( unsigned int channel );
		Input<int16_t> getValue( unsigned int channel );
		Input<double> getFormattedValue( unsigned int channel );
